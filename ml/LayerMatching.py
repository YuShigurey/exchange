...
def save_labeled_image(image, label, output_path):
    labeled_image = image.copy()
    cv2.putText(labeled_image, label, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
label = detect_and_label(preprocessed_image, model)

# Save the labeled image
save_labeled_image(image, label, output_image_path)